...
title: "用 gitbook 来写书"
toc: "true"
modifyTime: "2015-09-11 01:44:21"
description: ""
category: 记录
...
对于 gitbook-theme-X 的插件，请这样安装 :  `book-dir $ gitbook install`  或者 `npm install gitbook-plugin-X`

对于 gitbook-theme-X 的插件，请这样安装 : `npm install gitbook-theme-X && mv node_modules/gitbook-theme-X node_modules/gitbook-plugin-X`
